layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [
            [
                {field: 'categoryId', title: '商品类别', width: 150},
            ...
            // {field: 'description', title: '商品描述' },
                {field: 'mainImage', title: '商品图片', templet: function(img) {
                return '<img src=' + img.mainImage.split("&&")[0] +' />';
                }, width: 150},
                {field: 'stock', title: '库存'},
                {field: 'status', title: '商品状态', width: 150},
    ...
    function editShop(data){ // 修改商品信息
        var index = layui.layer.open({
            ...
            success : function(layero, index){
                ...
                body.find(".mainImage").val(data.mainImage);
