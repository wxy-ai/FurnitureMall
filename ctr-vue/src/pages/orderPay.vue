            ...
            <div class="container">
                <div class="order-wrap">
                    ...
                    <div class="order-close">
                        <div class="reg" @click="goToCloseOrder">取消订单</div>
                    </div>
                </div>
<!--                <div class="item-pay">-->
<!--                    <h3>选择以下支付方式付款</h3>-->
...
<!--                </div>-->
                <div class="btn-group">
                    <a href="javascript:;" class="btn btn-large" @click="confirmSubmit">确定支付</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            confirmSubmit(){
                this.axios.post(`/orders/${this.orderNo}`).then(()=>{
