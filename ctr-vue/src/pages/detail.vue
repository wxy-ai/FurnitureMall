            ...
            <div class="container clearfix">
                <div class="swiper">
                    <swiper :options="swiperOption">
                        <swiper-slide><img v-bind:src="subImg[0]" alt=""></swiper-slide>
                        <swiper-slide><img v-bind:src="subImg[1]" alt=""></swiper-slide>
                        <swiper-slide><img v-bind:src="subImg[2]" alt=""></swiper-slide>
                        <swiper-slide><img v-bind:src="subImg[3]" alt=""></swiper-slide>
                        <!-- Optional controls -->
        ...
        methods:{
            getProductInfo(){
                this.axios.get(`/products/${this.id}`).then((res)=>{
                    this.product = res;
                    this.subImg = res.subImages.split(",");
