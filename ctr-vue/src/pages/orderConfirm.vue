        ...
        >
            <template v-slot:body>
                <div class="edit-wrap">
                    ...
                    <div class="item">
<!--                        <input type="text" class="input" placeholder="姓名" v-model="checkedItem.receiverProvince">-->
<!--                        <input type="text" class="input" placeholder="手机号" v-model="checkedItem.receiverCity">-->
<!--                        <input type="text" class="input" placeholder="手机号" v-model="checkedItem.receiverDistrict">-->
